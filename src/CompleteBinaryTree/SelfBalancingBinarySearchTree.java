...
/* Class CompleteBinaryTree.SBBSTNode */
class SBBSTNode
{
...
/* Class CompleteBinaryTree.SelfBalancingBinarySearchTree */
...
class SelfBalancingBinarySearchTreeTest {
    public static void main(String[] args) {
        ...
        /* Creating object of CompleteBinaryTree.SelfBalancingBinarySearchTree */
        SelfBalancingBinarySearchTree sbbst = new SelfBalancingBinarySearchTree();
        System.out.println("CompleteBinaryTree.SelfBalancingBinarySearchTree Test\n");
        char ch;
        /*  Perform tree operations  */
        do {
            System.out.println("\nCompleteBinaryTree.SelfBalancingBinarySearchTree Operations\n");
